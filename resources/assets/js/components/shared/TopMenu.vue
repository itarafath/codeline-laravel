        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <router-link v-show="!isLoggedIn" :to="{name: 'login'}" tag="li" class="nav-item"
                                 activeClass="active" exact>
                        <a class="nav-link">Login</a>
                    </router-link>

                    <router-link v-show="!isLoggedIn" :to="{name: 'register'}" tag="li" class="nav-item"
                                 activeClass="active" exact>
                        <a class="nav-link">Register</a>
                    </router-link>
                    <router-link v-show="isLoggedIn" :to="{name: 'film_create'}" tag="li" class="nav-item"
                                 activeClass="active">
